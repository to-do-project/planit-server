...
public interface DeviceTokenRepository extends JpaRepository<DeviceToken,Long> {
    ...
    @Query("select d from DeviceToken d where d.user.userId = :userId and d.deviceToken= :deviceToken")
    ...
    public boolean existsByUserAndDeviceToken(User user,@Param("deviceToken") String deviceToken);
